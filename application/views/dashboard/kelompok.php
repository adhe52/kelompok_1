                ...
                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                    <div class="card bg-light d-flex flex-fill">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="lead"><b>Ade Herawan </b></h2>
                                    <p class="text-muted text-sm"><b>About: </b> UBSI / 17207074 / Teknologi Informasi </p>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Jl. Raya Centex, Ciracas Jakarta Timur</li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: 0812-9470-6385</li>
                                    </ul>
                                </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                    <div class="card bg-light d-flex flex-fill">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="lead"><b>Awal Ganang</b></h2>
                                    <p class="text-muted text-sm"><b>About: </b> UBSI / 17207074 / Teknologi Informasi </p>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Kramat 98, senen Jakarta Pusat</li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: 0819-4546-7171</li>
                                    </ul>
                                </div>
                                <div class="col-5 text-center">
